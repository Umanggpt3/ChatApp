...
public class MessageActivity extends AppCompatActivity {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (user.getImageURL().equals("default")) {
                    profile_image.setImageResource(R.mipmap.ic_user);
                } else {
    ...
    private void sendMessage(String sender, final String receiver, String message) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (notify) {
                    assert user != null;
                    Log.d("0000000", "sendNotification" + user.getUsername() + "   " + notify);
    ...
    private void sendNotification(String receiver, final String username, final String message) {
        Log.d("0000000","sendNotification");
                    ...
                    apiService.sendNotification(sender)
                            .enqueue(new Callback<MyResponse>() {
                                ...
                                public void onResponse(retrofit2.Call<MyResponse> call, retrofit2.Response<MyResponse> response) {
                                    ...
                                    Log.d("0000000","apiService.sendNotification" + response.body().success);
